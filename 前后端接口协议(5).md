    ...
    "devices": [
      {
        ...
        "location": "杭州",
        "current_action": "吃饭",
        "traffic_statistics": "56841.12MB",
        "last_heartbeat": "2025-11-21T15:51:00Z",
        "process_name": "测试流程1",
        "process_id": "P001"
      },
      {
        "serial_number": "SN999325",
        "status": "离线",
        "location": "杭州",
        "current_action": "闲置",
        "traffic_statistics": "56841.12MB",
        "last_heartbeat": "2025-11-25T15:51:00Z",
        "process_name": "测试流程2",
        "process_id": "P002"
      }
    ]
...
```
{
  ...
  "data": {
    ...
    "remark":"asddsaasdddddddddddddddddddddddddddd",
    "serial_numbers": [
      "SN999321",
      "SN999322",
      "SN999323",
...
接口路径：`/device/{process_id}/update` (修改单个流程内容)
 描述：此接口用于修改指定流程的详细内容，包括步骤、时间、备注等信息。
